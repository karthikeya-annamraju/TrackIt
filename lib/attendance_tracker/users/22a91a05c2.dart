...
class AttendanceTrackerC2 extends StatefulWidget {
  const AttendanceTrackerC2({super.key});

  @override
  State<AttendanceTrackerC2> createState() => _AttendanceTrackerState();
}

class _AttendanceTrackerState extends State<AttendanceTrackerC2> {
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => StudentProfileScreenNew(
                  name: "D Suresh Reddy",
                  rollNumber: '22A91A05C2',
                  phoneNumber: '9954312124',
                  // image: 'assets/images/22a91a05c2.jpg',
                  image: 'https://info.aec.edu.in/AEC/StudentPhotos/22a91a05c2.jpg',
                  section: 'III CSE-D',
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('assets/images/22a91a05c2.jpg'),
                      fit: BoxFit.fill,
                    )
                ),
              ),
